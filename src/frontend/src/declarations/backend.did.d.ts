...
export interface Category { 'name' : string, 'txType' : string }
...
export interface _SERVICE {
  ...
  'addCategory' : ActorMethod<[string, string], boolean>,
  'addTransaction' : ActorMethod<[Transaction], bigint>,
  'addTransactionType' : ActorMethod<[string], boolean>,
  ...
  'getTransactionTypes' : ActorMethod<[], Array<TransactionType>>,
  'getTransactions' : ActorMethod<[], Array<Transaction>>,
  'getUserProfile' : ActorMethod<[Principal], [] | [UserProfile]>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'saveCallerUserProfile' : ActorMethod<[UserProfile], undefined>,
  'updateCategory' : ActorMethod<[string, string, string], boolean>,
  'updateTransaction' : ActorMethod<[Transaction], boolean>,
}
